...
export const OverlaysActionTypes = {
	SELECT_OVERLAY: type('[Overlay] Select IOverlay'),
	UNSELECT_OVERLAY: type('[Overlay] Unselect IOverlay'),
	LOAD_OVERLAYS: type('[Overlay] Load Overlays'),
	REQUEST_OVERLAY_FROM_BACKEND: type('[Overlay] Load IOverlay By Id'),
	...
	DISPLAY_OVERLAY_FROM_STORE: type('[Overlay] Display IOverlay From Store'),
	DISPLAY_MULTIPLE_OVERLAYS_FROM_STORE: type('[Overlay] Display Multiple Overlays From Store'),
	DISPLAY_OVERLAY: type('[Overlay] Display IOverlay'),
	DISPLAY_OVERLAY_SUCCESS: type('[Overlay] Display IOverlay Success'),
	DISPLAY_OVERLAY_FAILED: type('[Overlay] Display IOverlay Failed'),
