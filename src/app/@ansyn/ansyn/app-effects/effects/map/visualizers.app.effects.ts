...
import { CaseMapState, CasePreview } from '@ansyn/core/models/case.model';
...
export class VisualizersAppEffects {
	...
	// 	.filter(([action, mapState, selectedCase]: [DisplayOverlaySuccessAction | BackToWorldView, IMapState, CasePreview]) => Boolean(selectedCase && selectedCase.state.contextEntities) && selectedCase.state.contextEntities.length > 0)
