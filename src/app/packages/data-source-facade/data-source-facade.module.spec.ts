...
import { DataSourceFacadeModule } from "./data-source-facade.module"
...
fdescribe('DataSourceFacadeModule', () => {
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
            imports: [
                DataSourceFacadeModule.register(SourceProviderMock1),
                DataSourceFacadeModule.register(SourceProviderMock2)
            ],
			providers:[
