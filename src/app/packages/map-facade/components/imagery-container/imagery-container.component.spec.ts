...
describe('ImageryContainerComponent', () => {
	...
	beforeEach(async(() => {
		TestBed.configureTestingModule({
			declarations: [ ImageryContainerComponent, MockComponent({selector: 'ansyn-imagery-status', inputs: ['map_id', 'active']}), MockComponent({selector: 'imagery-view', inputs: ['mapComponentSettings']}) ]
		})
			.compileComponents();
	}));
