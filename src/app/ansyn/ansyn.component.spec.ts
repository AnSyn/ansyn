...
describe('AnsynComponent', () => {
	...
	const mock_status = MockComponent({selector: 'ansyn-status-bar', inputs: ['selected_case_name']});
	...
	beforeEach(async(() => {
		TestBed.configureTestingModule({
			...
			imports: [StoreModule.provideStore({status_bar: StatusBarReducer, cases: CasesReducer}),AppRouter],
