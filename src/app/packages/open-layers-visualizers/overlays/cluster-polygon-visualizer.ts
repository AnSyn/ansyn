 ...
 */
import { IMap, IVisualizerEntity } from '@ansyn/imagery';
import * as ol from 'openlayers';
import { BaseVisualizer } from '../base-visualizer';

export const FootprintClusterPolygonVisualizerType = 'FootprintClusterPolygonVisualizer';

export class FootprintClusterPolygonVisualizer extends BaseVisualizer {
	...
	constructor(args: any) {
		super(FootprintClusterPolygonVisualizerType, args);
	}
	...
	private clusterFeatureStyleFunction(feature, resolution) {
