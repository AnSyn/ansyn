...
export const selectPaginatedDrops = (from, to = 15) => createSelector(overlaysStateSelector, (overlays: IOverlaysState) => overlays && overlays.drops && overlays.drops.slice(from, from + to));
