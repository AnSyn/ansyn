...
export function validateFeatureProperties(feature: Feature<any>): Feature<any> {
	...
	featureJson.properties = {
		...
		labelSize: (!isNaN(labelSize) && typeof labelSize === 'number') ? labelSize : defaultProperties.labelSize,
		...
		style: {
			...
			initial: {
				...
				'stroke-width': (!!initial && !isNaN(initial['stroke-width']) && typeof initial['stroke-width'] === 'number') ? initial['stroke-width'] : defaultStyle.initial['stroke-width'],
				fill: (!!initial && !!initial.fill && typeof initial.fill === 'string') ? initial.fill : defaultStyle.initial.fill,
				'fill-opacity': (!!initial && !isNaN(initial['fill-opacity']) && typeof initial['fill-opacity'] === 'number') ? initial['fill-opacity'] : defaultStyle.initial['fill-opacity'],
				'stroke-opacity': (!!initial && !isNaN(initial['stroke-opacity']) && typeof initial['stroke-opacity'] === 'number') ? initial['stroke-opacity'] : defaultStyle.initial['stroke-opacity'],
				'stroke-dasharray': (!!initial && !isNaN(initial['stroke-dasharray']) && typeof initial['stroke-dasharray'] === 'number') ? initial['stroke-dasharray'] : defaultStyle.initial['stroke-dasharray'],
				...
				label: {
					...
					offsetY: (!!initial && !isNaN(initial.label) && !!initial.label.offsetY && typeof initial.label.offsetY === 'number') ? initial.label.offsetY : defaultStyle.initial.label.offsetY
				}
			}
		},
