...
import { selectIsRunSecondSearch } from '../../../overlays/reducers/overlays.reducer';
...
export class CasesEffects {
	...
	onSaveCaseAs$ = this.actions$.pipe(
		...
		cloneDeep(),
		withLatestFrom(this.store.select(selectLayers), this.store.select(selectIsRunSecondSearch)),
